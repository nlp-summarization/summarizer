...
def PythonROUGE(current_dir, guess_summ_list,ref_summ_list,ngram_order=2):
    """ Wrapper function to use ROUGE from Python easily. """
...
#/Users/ismailmustafa/Desktop/NYUWork/StatisticalNLP/PythonROUGE
    
    
    if(current_dir == None):
        current_dir = os.getcwd() 

    ROUGE_path = current_dir + "/Rouge/RELEASE-1.5.5/ROUGE-1.5.5.pl"

    data_path = current_dir + "/Rouge/RELEASE-1.5.5/data"
